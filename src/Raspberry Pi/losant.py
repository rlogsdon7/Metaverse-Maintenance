...
#Row 1-3
speedLabel=Label(root,text="Speed",font="times 48 bold")
speedLabel.grid(row=1,column=1)
speedHolder=Label(root,text ="          ",font=("times",140,"bold"),bg="white")
speedHolder.grid(row=2,column=1,pady=10,padx=10,ipady=30)
xspeed=Label(root,font=("times",140,"bold"),bg="white")
xspeed.grid(row=2,column=1,pady=10,padx=50,ipady=10)
speedUnit=Label(root,text="MPH",font="times 24 bold")
speedUnit.grid(row=3,column=1)

RPMLabel=Label(root,text="Revolutions Per Minute",font="times 48 bold")
RPMLabel.grid(row=1,column=2)
RPMHolder=Label(root,text ="              ",font=("times",140,"bold"),bg="white")
RPMHolder.grid(row=2,column=2,pady=10,padx=50,ipady=30)
xRPM=Label(root,font=("times",140,"bold"),bg="white")
xRPM.grid(row=2,column=2,pady=10,padx=50,ipady=10)
RPMUnit=Label(root,text="RPM",font="times 24 bold")
RPMUnit.grid(row=3,column=2)

TPLabel=Label(root,text="Throttle Position",font="times 48 bold")
TPLabel.grid(row=1,column=3)
TPHolder=Label(root,text ="          ",font=("times",140,"bold"),bg="white")
TPHolder.grid(row=2,column=3,pady=10,padx=50,ipady=30)
xTP=Label(root,font=("times",140,"bold"),bg="white")
xTP.grid(row=2,column=3,pady=10,padx=50,ipady=10)
TPUnit=Label(root,text="%",font="times 24 bold")
...
#Row 5-7
ENGLabel=Label(root,text="Engine Load",font="times 48 bold")
ENGLabel.grid(row=5,column=1)
ENGHolder=Label(root,text ="          ",font=("times",140,"bold"),bg="white")
ENGHolder.grid(row=6,column=1,pady=10,padx=10,ipady=30)
xENG=Label(root,font=("times",140,"bold"),bg="white")
xENG.grid(row=6,column=1,pady=10,padx=50,ipady=10)
ENGUnit=Label(root,text="%",font="times 24 bold")
ENGUnit.grid(row=7,column=1)

VoltageLabel=Label(root,text="Controle Module Voltage",font="times 48 bold")
VoltageLabel.grid(row=5,column=2)
VoltageHolder=Label(root,text ="          ",font=("times",140,"bold"),bg="white")
VoltageHolder.grid(row=6,column=2,pady=10,padx=50,ipady=30)
xVoltage=Label(root,font=("times",140,"bold"),bg="white")
xVoltage.grid(row=6,column=2,pady=10,padx=50,ipady=10)
VoltageUnit=Label(root,text="Volts",font="times 24 bold")
VoltageUnit.grid(row=7,column=2)

TimingLabel=Label(root,text="Timing Advance",font="times 48 bold")
TimingLabel.grid(row=5,column=3)
TimingHolder=Label(root,text ="          ",font=("times",140,"bold"),bg="white")
TimingHolder.grid(row=6,column=3,pady=10,padx=50,ipady=30)
xTiming=Label(root,font=("times",140,"bold"),bg="white")
xTiming.grid(row=6,column=3,pady=10,padx=50,ipady=10)
TimingUnit=Label(root,text="Degrees",font="times 24 bold")
